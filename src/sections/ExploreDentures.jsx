          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mt-12">
            <Fade direction="up">
              <div className="rounded-lg bg-white shadow-lg p-6 transform transition hover:scale-105">
                <div className="h-40 bg-gradient-to-r from-blue-500 to-green-500 rounded-md mb-4 flex items-center justify-center text-white text-lg font-bold">
                  Full Dentures
                </div>
            ...
            <Fade direction="up">
              <div className="rounded-lg bg-white shadow-lg p-6 transform transition hover:scale-105">
                <div className="h-40 bg-gradient-to-r from-purple-500 to-pink-500 rounded-md mb-4 flex items-center justify-center text-white text-lg font-bold">
                  Partial Dentures
                </div>
            ...
            <Fade direction="up">
              <div className="rounded-lg bg-white shadow-lg p-6 transform transition hover:scale-105">
                <div className="h-40 bg-gradient-to-r from-yellow-500 to-red-500 rounded-md mb-4 flex items-center justify-center text-white text-lg font-bold">
