...
import tw1 from "../../public/images/TW/tw1.avif";
import tw2 from "../../public/images/TW/tw2.jpg";
...
<section className="py-16 bg-white">
  <div className="max-w-7xl mx-auto px-6">
    ...
    <div className="mt-12 flex justify-center">
      <div className="h-64 w-full max-w-3xl rounded-lg overflow-hidden shadow-md">
        <img 
          src={tw1}
          alt="Professional in-office teeth whitening procedure"
...
<section className="py-16 bg-blue-100">
  <div className="max-w-7xl mx-auto px-6">
    ...
    <div className="mt-12 flex justify-center">
      <div className="h-[28rem] w-full max-w-3xl rounded-lg overflow-hidden shadow-md">
        <img 
          src={tw2}
          alt="At-home teeth whitening kit"
          className="w-full h-full object-cover hover:scale-105 transition-transform duration-300"
        />
      </div>
    </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <Fade direction="up">
            ...
            <div className="grid md:grid-cols-2 gap-12">
              <div className="bg-gradient-to-r from-blue-800 to-blue-500 p-6 rounded-lg text-white shadow-md">
