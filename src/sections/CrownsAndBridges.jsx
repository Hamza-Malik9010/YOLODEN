    ...
    <main className="bg-gray-50 text-gray-800 pt-16">
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <Fade direction="up">
            <div className="bg-gradient-to-r from-blue-500 to-blue-800 w-full h-64 flex items-center justify-center rounded-md mb-8">
              <span className="text-white text-lg font-bold">[Crowns and Bridges Image Placeholder]</span>
            </div>
          </Fade>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <Fade direction="up">
              <div className="rounded-lg bg-white shadow-lg p-6 transform transition hover:scale-105">
                ...
                <div className="bg-blue-100 w-full h-48 flex items-center justify-center rounded-md">
                  <span className="text-gray-500">[Porcelain Crowns Image Placeholder]</span>
                </div>
              </div>
            </Fade>
            <Fade direction="up">
              <div className="rounded-lg bg-white shadow-lg p-6 transform transition hover:scale-105">
                ...
                <div className="bg-blue-100 w-full h-48 flex items-center justify-center rounded-md">
                  <span className="text-gray-500">[Metal Crowns Image Placeholder]</span>
                </div>
              </div>
            </Fade>
            <Fade direction="up">
              <div className="rounded-lg bg-white shadow-lg p-6 transform transition hover:scale-105">
                ...
                <div className="bg-gray-300 w-full h-48 flex items-center justify-center rounded-md">
                  <span className="text-gray-500">[Ceramic Bridges Image Placeholder]</span>
                </div>
              </div>
            </Fade>
          </div>
