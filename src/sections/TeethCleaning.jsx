...
import tc1 from "../../public/images/TC/tc1.avif";
import tc2 from "../../public/images/TC/tc2.jpg";
        ...
        <div className="max-w-7xl mx-auto px-6">
          <Fade direction="left">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
              ...
              <div className="flex flex-col">
                <div className="h-48 rounded-lg overflow-hidden bg-gradient-to-r from-purple-500 to-pink-500">
                  <img 
                    src={tc2} 
                    alt="Healthy smile benefits" 
                    className="w-full h-full object-cover"
                  />
                </div>
                <p className="mt-6 text-gray-700">
