      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <Fade direction="left">
            ...
            <div className="h-64 bg-gradient-to-r from-blue-500 to-green-500 rounded-lg mt-8 flex items-center justify-center text-white text-lg font-bold">
              [Image Placeholder for Root Canal Process]
            </div>
          </Fade>
        </div>
      </section>
          ...
          <Fade direction="up">
            ...
            <div className="grid md:grid-cols-3 gap-12 mt-12">
              <div className="bg-white shadow-lg p-6 rounded-lg transform transition hover:scale-105">
                ...
                <div className="h-48 bg-gradient-to-r from-blue-500 to-green-500 rounded-lg mt-6 flex items-center justify-center text-white font-bold">
                  [X-ray Placeholder]
                </div>
              </div>
              <div className="bg-white shadow-lg p-6 rounded-lg transform transition hover:scale-105">
                ...
                <div className="h-48 bg-gradient-to-r from-purple-500 to-pink-500 rounded-lg mt-6 flex items-center justify-center text-white font-bold">
              ...
              <div className="bg-white shadow-lg p-6 rounded-lg transform transition hover:scale-105">
                ...
                <div className="h-48 bg-gradient-to-r from-yellow-500 to-red-500 rounded-lg mt-6 flex items-center justify-center text-white font-bold">
