        ...
        <div className="max-w-7xl mx-auto px-6">
          <Fade direction="left">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mt-12">
              <div>
                <div className="h-48 bg-gradient-to-r from-blue-500 to-blue-800 rounded-lg flex items-center justify-center text-white text-lg font-bold">Image</div>
              ...
              <div>
                <div className="h-48 bg-gradient-to-r from-blue-500 to-pink-800 rounded-lg flex items-center justify-center text-white text-lg font-bold">Image</div>
                <p className="mt-6 text-gray-700">
